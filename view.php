		...
		<div class="container-fluid">
			<div class="navbar-header">
				<a class="navbar-brand" href="#">
					...
					<button style="background-color: #27B629;border-radius: 7px;">
						...
						<tr>
							...
							<td>
								<form action='delete.php?id=<?php echo $row['user_id1'];?>' method="post">
									...
									<button type="submit" value="Delete" onclick="return confirm('Are you sure you want to delete this event?');" name="submit" style="background-color: #E4694E;border-radius:5px;">
